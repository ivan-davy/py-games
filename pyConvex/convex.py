...
class Segment(Figure):
    ...
    def min_dist(self):
        if self.p.dist(p4) < self.q.dist(p4):
            return self.p.dist(p4)
        else:
            return self.q.dist(p4)
...
class Polygon(Figure):
    ...
    def __init__(self, a, b, c):
        ...
        self.dists = [a.dist(p4), b.dist(p4), c.dist(p4)]
        self.dists.sort()
